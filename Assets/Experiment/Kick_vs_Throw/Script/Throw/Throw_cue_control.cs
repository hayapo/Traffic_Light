...
public class Throw_cue_control : MonoBehaviour
{
    // Constants
    ...
    private IEnumerator Start()
    {
        ...
        try
        {
            ...
            else
            {
                ...
                // Generate filename
                logFileName = $"brainflow_log_throw-cue_sub-{SubjectNumber}";
                rawdataFileName = $"brainflow_data_throw-cue_sub-{SubjectNumber}";
            }
